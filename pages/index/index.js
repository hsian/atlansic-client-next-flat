                ...
                <div className={cls('ui grid padded container')}>
                        ...
                        <div className="ui large feed container">
                            <div className="event">
                                ...
                                <div className="content">
                                    <div className="summary"><a className="user"> Elliot Fu </a> added you as a friend <div className="date">1 小时前 </div>
                                </div>
                                <div className="meta">
                    ...
                    <div className={cls('column four wide right floated row')}>
                        ...
                        <div className={cls("ui vertical menu", styles.asideMenu)}>
                            ...
                            <a class="item">
                                <h4 class="ui header">优惠券</h4>
                                <p>看看我们的优惠券集合</p>
                            </a>
                            <a class="item">
                                <h4 class="ui header">折扣</h4>
